...
> **Note**: The theme editor GUI will only appear for the default theme or themes derived from the default (that share "default-styles.min.css" as part of the file name).
...
## Building
run `npm i`, then `npm run minify` to minify the default theme.
