...
function continueLoading() {
    ...
    chrome.storage.sync.get(['currentTheme', 'jrCount'], function(result) {
        ...
        if(typeof result.jrCount === "undefined") {
            ...
            jrCount = parseInt(result.jrCount); // Parseint can be taken out later
...
var isPaused = false,
    stylesheetObj = {},
    stylesheetVersion = 1.21; // THIS NUMBER MUST BE CHANGED FOR THE STYLESHEETS TO KNOW TO UPDATE
